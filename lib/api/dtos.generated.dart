// DTOs autogenerated at 2019-08-10 11:12:17
...
class ManualImportTransaction {
    ...
    ManualImportTransaction.fromJson(Map<String, dynamic> json)
      : count = (json['count'] as num).toDouble(),date =  InstantWrapper.fromJson(json['date'] as int),pricePerShare = (json['pricePerShare'] as num).toDouble(),symbol = json['symbol'] as String,totalSpent = (json['totalSpent'] as num).toDouble(),type = convertTransactionTypeFromJson(json['type'] as String);
...
class PdStockDataSnapshotEntity {
    ...
    PdStockDataSnapshotEntity.fromJson(Map<String, dynamic> json)
      : currency =  Currency.fromJson(json['currency'] as Map<String, dynamic>),date =  InstantWrapper.fromJson(json['date'] as int),epsForward = (json['epsForward'] as num).toDouble(),epsTrailing = (json['epsTrailing'] as num).toDouble(),exchangeName = json['exchangeName'] as String,floatShares = (json['floatShares'] as num).toDouble(),id = json['id'] as String,instrument =  PdInstrumentEntity.fromJson(json['instrument'] as Map<String, dynamic>),lastSplitDate =  InstantWrapper.fromJson(json['lastSplitDate'] as int),lastSplitFactor = json['lastSplitFactor'] as String,marketCap = (json['marketCap'] as num).toDouble(),micCompositionCode = json['micCompositionCode'] as String,peForward = (json['peForward'] as num).toDouble(),peTrailing = (json['peTrailing'] as num).toDouble(),profitMargins = (json['profitMargins'] as num).toDouble(),regularMarketPrice = (json['regularMarketPrice'] as num).toDouble(),sharesOutstanding = (json['sharesOutstanding'] as num).toDouble(),sharesShort = (json['sharesShort'] as num).toDouble(),volume = (json['volume'] as num).toDouble();
...
class Transaction {
    ...
    Transaction.fromJson(Map<String, dynamic> json)
      : count = (json['count'] as num).toDouble(),createdAt =  InstantWrapper.fromJson(json['createdAt'] as int),id = json['id'] as String,instrument =  Instrument.fromJson(json['instrument'] as Map<String, dynamic>),label =  Label.fromJson(json['label'] as Map<String, dynamic>),transactionAt =  InstantWrapper.fromJson(json['transactionAt'] as int),type = convertTransactionTypeFromJson(json['type'] as String),values = (json['values'] as List<dynamic>).map((dynamic val) =>  TransactionValue.fromJson(val as Map<String, dynamic>)).toList();
...
class UserAuthEmailToken {
    ...
    UserAuthEmailToken.fromJson(Map<String, dynamic> json)
      : createdAt =  InstantWrapper.fromJson(json['createdAt'] as int),email = json['email'] as String,sentEmailAt =  InstantWrapper.fromJson(json['sentEmailAt'] as int),token = json['token'] as String,usedAt =  InstantWrapper.fromJson(json['usedAt'] as int),user =  UserInfo.fromJson(json['user'] as Map<String, dynamic>);
...
class UserInfo {
    ...
    UserInfo.fromJson(Map<String, dynamic> json)
      : authTokens = (json['authTokens'] as List<dynamic>).map((dynamic val) =>  UserAuthEmailToken.fromJson(val as Map<String, dynamic>)).toList(),createdAt =  InstantWrapper.fromJson(json['createdAt'] as int),displayName = json['displayName'] as String,email = json['email'] as String,firstName = json['firstName'] as String,id = json['id'] as String,lastName = json['lastName'] as String,passwordHash = json['passwordHash'] as String,phoneNumber = json['phoneNumber'] as String,userType = convertUserTypeFromJson(json['userType'] as String);
...
class UserInfoResponse {
    ...
    UserInfoResponse.fromJson(Map<String, dynamic> json)
      : avatarUrl = json['avatarUrl'] as String,createdAt =  InstantWrapper.fromJson(json['createdAt'] as int),displayName = json['displayName'] as String,email = json['email'] as String,key = json['key'] as String,statsCorrectAnswers = json['statsCorrectAnswers'] as int,statsTotalTurns = json['statsTotalTurns'] as int,userType = convertGameUserTypeFromJson(json['userType'] as String);
