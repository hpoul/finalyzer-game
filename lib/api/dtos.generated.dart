// DTOs autogenerated at 2019-08-10 10:25:47
...
case 'CUSTOM_CSV_FORMAT': return ImportType.CUSTOM_CSV_FORMAT;
...
case ImportType.CUSTOM_CSV_FORMAT: return 'CUSTOM_CSV_FORMAT';
...
class AppMetricsDto {
    ...
    Map<String, dynamic> toJson() => <String, dynamic>{ 'labelCount': labelCount,'lastImportEodStats': lastImportEodStats,'logEventCount': logEventCount,'userCount': userCount };
...
class AuthenticatedTestMethodLocation implements GetLocation<TestMethodGetResponse>, PostBodyLocation<TestMethodPostRequest, TestMethodPostResponse>, PutBodyLocation<TestMethodPutRequest, TestMethodPutResponse> {
    ...
    Map<String, dynamic> toJson() => <String, dynamic>{ 'authParam': authParam };

    @override String get path => 'api/test/auth/method/{authParam}'.replaceAll('{authParam}', this.authParam);

    String authParam;
    @override TestMethodGetResponse bodyFromGetJson(dynamic json) =>  TestMethodGetResponse.fromJson(json as Map<String, dynamic>);
                @override TestMethodPostResponse bodyFromPostJson(dynamic json) =>  TestMethodPostResponse.fromJson(json as Map<String, dynamic>);
                @override TestMethodPutResponse bodyFromPutJson(dynamic json) =>  TestMethodPutResponse.fromJson(json as Map<String, dynamic>);
}
...
class BiggestMover {
    ...
    BiggestMover.fromJson(Map<String, dynamic> json)
      : compareValue = (json['compareValue'] as num).toDouble(),instrument =  PdInstrumentDto.fromJson(json['instrument'] as Map<String, dynamic>),value = (json['value'] as num).toDouble();

    Map<String, dynamic> toJson() => <String, dynamic>{ 'compareValue': compareValue,'instrument': instrument.toJson(),'value': value };
...
class BiggestMovers implements GetLocation<BiggestMoversResponse> {
    ...
    Map<String, dynamic> toJson() => <String, dynamic>{ 'endDate': endDate,'startDate': startDate,'type': convertMoverTypeToJson(type) };

    @override String get path => Uri.parse('api/pricedata/biggestMovers').replace(queryParameters: <String, dynamic>{'endDate': endDate?.toString(),'startDate': startDate?.toString(),'type': type,}).toString();

    /* yyyy-mm-dd date LocalDate */String endDate;
                /* yyyy-mm-dd date LocalDate */String startDate;
                MoverType type;
    @override BiggestMoversResponse bodyFromGetJson(dynamic json) =>  BiggestMoversResponse.fromJson(json as Map<String, dynamic>);
}
...
class BiggestMoversResponse {
    ...
    BiggestMoversResponse.fromJson(Map<String, dynamic> json)
      : biggestMovers = (json['biggestMovers'] as List<dynamic>).map((dynamic val) =>  BiggestMover.fromJson(val as Map<String, dynamic>)).toList();

    Map<String, dynamic> toJson() => <String, dynamic>{ 'biggestMovers': biggestMovers.map<dynamic>((dynamic val) => val.toJson()).toList() };
...
class CompanyInfoDescription {
    ...
    Map<String, dynamic> toJson() => <String, dynamic>{ 'content': content,'source': convertDescriptionSourceToJson(source),'sourceUrl': sourceUrl };
...
class CompanyInfoDetails {
    ...
    CompanyInfoDetails.fromJson(Map<String, dynamic> json)
      : description = json['description'] as String,extractText = json['extractText'] == null ? null :  CompanyInfoDescription.fromJson(json['extractText'] as Map<String, dynamic>),instrumentKey = json['instrumentKey'] as String,name = json['name'] as String,symbol = json['symbol'] as String,website = json['website'] as String,wikipediaArticleUri = json['wikipediaArticleUri'] as String;

    Map<String, dynamic> toJson() => <String, dynamic>{ 'description': description,'extractText': extractText.toJson(),'instrumentKey': instrumentKey,'name': name,'symbol': symbol,'website': website,'wikipediaArticleUri': wikipediaArticleUri };
...
class ContextAnonymousDto implements ContextDto {
    ...
    Map<String, dynamic> toJson() => <String, dynamic>{ 'loggedIn': loggedIn };
...
class ContextLoggedInDto implements ContextDto {
    ...
    Map<String, dynamic> toJson() => <String, dynamic>{ 'loggedIn': loggedIn,'email': email,'userId': userId,'userType': convertUserTypeToJson(userType) };
...
class ContextRequest implements PostBodyLocation<EmptyRequestDto, ContextDto> {
    ...
    @override String get path => 'api/auth/context';

    
    @override ContextDto bodyFromPostJson(dynamic json) =>  ContextDto.fromJson(json as Map<String, dynamic>);
}
...
class Currency {
    ...
    Map<String, dynamic> toJson() => <String, dynamic>{ 'currencyCode': currencyCode,'defaultFractionDigits': defaultFractionDigits,'numericCode': numericCode };
...
class CurrencyConversion {
    ...
    Map<String, dynamic> toJson() => <String, dynamic>{ 'source': source,'symbol': symbol,'target': target };
...
class CurrencyInfo {
    ...
    Map<String, dynamic> toJson() => <String, dynamic>{ 'code': code,'name': name,'symbol': symbol };
...
class CustomCsvParserConfig implements ParserConfig {
    CustomCsvParserConfig(this.countColumn, this.csvDelimiter, this.defaultCurrency, this.exchangeColumn, this.exchangeMicMapping, this.priceColumn, this.priceCurrencyColumn, this.tickerSymbolColumn, this.transactionDateColumn, this.transactionTypeColumn);
    CustomCsvParserConfig.fromJson(Map<String, dynamic> json)
      : countColumn = json['countColumn'] as int,csvDelimiter = json['csvDelimiter'] as String,defaultCurrency = json['defaultCurrency'] as String,exchangeColumn = json['exchangeColumn'] as int,exchangeMicMapping = (json['exchangeMicMapping'] as Map<dynamic, dynamic>).map<String, String>((dynamic key, dynamic value) => MapEntry<String, String>(key as String, value as String)),priceColumn = json['priceColumn'] as int,priceCurrencyColumn = json['priceCurrencyColumn'] as int,tickerSymbolColumn = json['tickerSymbolColumn'] as int,transactionDateColumn = json['transactionDateColumn'] as int,transactionTypeColumn = json['transactionTypeColumn'] as int;

    Map<String, dynamic> toJson() => <String, dynamic>{ 'countColumn': countColumn,'csvDelimiter': csvDelimiter,'defaultCurrency': defaultCurrency,'exchangeColumn': exchangeColumn,'exchangeMicMapping': exchangeMicMapping.map<String, dynamic>((dynamic key, dynamic value) => MapEntry<String, dynamic>((key) as String, (value))),'priceColumn': priceColumn,'priceCurrencyColumn': priceCurrencyColumn,'tickerSymbolColumn': tickerSymbolColumn,'transactionDateColumn': transactionDateColumn,'transactionTypeColumn': transactionTypeColumn };
...
class EodInfo {
    EodInfo(this.fd);
    EodInfo.fromJson(Map<String, dynamic> json)
      : fd = json['fd'] as /* yyyy-mm-dd date LocalDate */String;

    Map<String, dynamic> toJson() => <String, dynamic>{ 'fd': fd };
...
class EodStockData implements GetLocation<EodStockDataResponse> {
    ...
    EodStockData.fromJson(Map<String, dynamic> json)
      : currency = json['currency'] as String,end = json['end'] as /* yyyy-mm-dd date LocalDate */String,sampleEveryN = json['sampleEveryN'] as int,start = json['start'] as /* yyyy-mm-dd date LocalDate */String,symbols = (json['symbols'] as List<dynamic>).map((dynamic val) => val as String).toList();

    Map<String, dynamic> toJson() => <String, dynamic>{ 'currency': currency,'end': end,'sampleEveryN': sampleEveryN,'start': start,'symbols': symbols.map<dynamic>((dynamic val) => val).toList() };

    @override String get path => Uri.parse('api/pricedata/eod').replace(queryParameters: <String, dynamic>{'currency': currency?.toString(),'end': end?.toString(),'sampleEveryN': sampleEveryN?.toString(),'start': start?.toString(),'symbols': symbols,}).toString();
    ...
    String currency;
                ...
                List<String> symbols;
    @override EodStockDataResponse bodyFromGetJson(dynamic json) =>  EodStockDataResponse.fromJson(json as Map<String, dynamic>);
}
...
class EodStockDataResponse {
    ...
    EodStockDataResponse.fromJson(Map<String, dynamic> json)
      : currencyConversions = (json['currencyConversions'] as List<dynamic>).map((dynamic val) =>  CurrencyConversion.fromJson(val as Map<String, dynamic>)).toList(),data = (json['data'] as Map<dynamic, dynamic>).map<String, List<double>>((dynamic key, dynamic value) => MapEntry<String, List<double>>(key as String, (value as List<dynamic>).map((dynamic val) => (val as num).toDouble()).toList())),info = (json['info'] as Map<dynamic, dynamic>).map<String, EodInfo>((dynamic key, dynamic value) => MapEntry<String, EodInfo>(key as String,  EodInfo.fromJson(value as Map<String, dynamic>))),sampleEveryNth = json['sampleEveryNth'] as int,snapshot = (json['snapshot'] as Map<dynamic, dynamic>).map<String, PdInstrument>((dynamic key, dynamic value) => MapEntry<String, PdInstrument>(key as String,  PdInstrument.fromJson(value as Map<String, dynamic>)));

    Map<String, dynamic> toJson() => <String, dynamic>{ 'currencyConversions': currencyConversions.map<dynamic>((dynamic val) => val.toJson()).toList(),'data': data.map<String, dynamic>((dynamic key, dynamic value) => MapEntry<String, dynamic>((key) as String, (value.map<dynamic>((dynamic val) => val).toList()))),'info': info.map<String, dynamic>((dynamic key, dynamic value) => MapEntry<String, dynamic>((key) as String, (value.toJson()))),'sampleEveryNth': sampleEveryNth,'snapshot': snapshot.map<String, dynamic>((dynamic key, dynamic value) => MapEntry<String, dynamic>((key) as String, (value.toJson()))) };
...
class Exchange {
    ...
    Map<String, dynamic> toJson() => <String, dynamic>{ 'country': country,'equityExchangeName': equityExchangeName,'id': id,'label': label,'micCode': micCode,'name': name,'operatingMicCode': operatingMicCode };
...
class GameChallengeDetailsParticipants {
    ...
    GameChallengeDetailsParticipants.fromJson(Map<String, dynamic> json)
      : baseInfo =  GameUserBaseInfo.fromJson(json['baseInfo'] as Map<String, dynamic>),myself = json['myself'] as bool,statsCorrectAnswers = json['statsCorrectAnswers'] as int,status = convertGameChallengeParticipantStatusFromJson(json['status'] as String);

    Map<String, dynamic> toJson() => <String, dynamic>{ 'baseInfo': baseInfo.toJson(),'myself': myself,'statsCorrectAnswers': statsCorrectAnswers,'status': convertGameChallengeParticipantStatusToJson(status) };
...
class GameChallengeDetailsResponse {
    ...
    GameChallengeDetailsResponse.fromJson(Map<String, dynamic> json)
      : baseInfo =  GameChallengeInfoDto.fromJson(json['baseInfo'] as Map<String, dynamic>),participants = (json['participants'] as List<dynamic>).map((dynamic val) =>  GameChallengeDetailsParticipants.fromJson(val as Map<String, dynamic>)).toList();

    Map<String, dynamic> toJson() => <String, dynamic>{ 'baseInfo': baseInfo.toJson(),'participants': participants.map<dynamic>((dynamic val) => val.toJson()).toList() };
...
class GameChallengeDto {
    ...
    GameChallengeDto.fromJson(Map<String, dynamic> json)
      : challengeId = json['challengeId'] as String,simpleGame = (json['simpleGame'] as List<dynamic>).map((dynamic val) =>  GameSimpleSetResponse.fromJson(val as Map<String, dynamic>)).toList();

    Map<String, dynamic> toJson() => <String, dynamic>{ 'challengeId': challengeId,'simpleGame': simpleGame.map<dynamic>((dynamic val) => val.toJson()).toList() };
...
class GameChallengeInviteCreateRequest {
    ...
    Map<String, dynamic> toJson() => <String, dynamic>{ 'displayName': displayName,'gameUserToken': gameUserToken,'type': convertGameChallengeInviteTypeToJson(type) };
...
class GameChallengeInviteInfoLocation implements GetLocation<GameChallengeInviteInfoResponse>, PutBodyLocation<GameChallengeInviteInfoAcceptRequest, GameChallengeDto> {
    ...
    @override String get path => 'api/game/challenge/invite/{token}'.replaceAll('{token}', this.token);

    String token;
    @override GameChallengeInviteInfoResponse bodyFromGetJson(dynamic json) =>  GameChallengeInviteInfoResponse.fromJson(json as Map<String, dynamic>);
                @override GameChallengeDto bodyFromPutJson(dynamic json) =>  GameChallengeDto.fromJson(json as Map<String, dynamic>);
}
...
class GameChallengeInviteInfoResponse {
    ...
    GameChallengeInviteInfoResponse.fromJson(Map<String, dynamic> json)
      : challengeType = convertGameChallengeTypeFromJson(json['challengeType'] as String),createdBy =  GameUserBaseInfo.fromJson(json['createdBy'] as Map<String, dynamic>);

    Map<String, dynamic> toJson() => <String, dynamic>{ 'challengeType': convertGameChallengeTypeToJson(challengeType),'createdBy': createdBy.toJson() };
...
class GameChallengeInviteLocation implements PostBodyLocation<GameChallengeInviteCreateRequest, GameChallengeInviteResponse> {
    ...
    @override String get path => 'api/game/challenge/invite';

    
    @override GameChallengeInviteResponse bodyFromPostJson(dynamic json) =>  GameChallengeInviteResponse.fromJson(json as Map<String, dynamic>);
}
...
class GameChallengeInviteResponse {
    ...
    Map<String, dynamic> toJson() => <String, dynamic>{ 'inviteToken': inviteToken };
...
class GameChallengeListLocation implements GetLocation<GameChallengeListResponse> {
    ...
    @override String get path => 'api/game/challenge/list';

    
    @override GameChallengeListResponse bodyFromGetJson(dynamic json) =>  GameChallengeListResponse.fromJson(json as Map<String, dynamic>);
}
...
class GameChallengeListResponse {
    ...
    GameChallengeListResponse.fromJson(Map<String, dynamic> json)
      : challenges = (json['challenges'] as List<dynamic>).map((dynamic val) =>  GameChallengeInfoDto.fromJson(val as Map<String, dynamic>)).toList(),currentWeeklyChallenge =  GameChallengeInfoDto.fromJson(json['currentWeeklyChallenge'] as Map<String, dynamic>);

    Map<String, dynamic> toJson() => <String, dynamic>{ 'challenges': challenges.map<dynamic>((dynamic val) => val.toJson()).toList(),'currentWeeklyChallenge': currentWeeklyChallenge.toJson() };
...
class GameChallengeLocation implements GetLocation<GameChallengeDetailsResponse>, PutBodyLocation<GameChallengeRequest, GameChallengeDto> {
    ...
    Map<String, dynamic> toJson() => <String, dynamic>{ 'challengeId': challengeId };

    @override String get path => 'api/game/challenge/{challengeId}'.replaceAll('{challengeId}', this.challengeId);

    String challengeId;
    @override GameChallengeDetailsResponse bodyFromGetJson(dynamic json) =>  GameChallengeDetailsResponse.fromJson(json as Map<String, dynamic>);
                @override GameChallengeDto bodyFromPutJson(dynamic json) =>  GameChallengeDto.fromJson(json as Map<String, dynamic>);
}
...
class GameChallengeRequest {
    ...
    Map<String, dynamic> toJson() => <String, dynamic>{ 'action': convertGameChallengeActionToJson(action) };
...
class GameNotification {
    ...
    Map<String, dynamic> toJson() => <String, dynamic>{ 'challengeId': challengeId,'inviteToken': inviteToken,'type': convertGameNotificationTypeToJson(type) };
...
class GameSimpleSetGuessDto {
    ...
    Map<String, dynamic> toJson() => <String, dynamic>{ 'instrumentKey': instrumentKey,'marketCap': marketCap };
...
class GameSimpleSetLocation implements GetLocation<GameSimpleSetResponse>, PostBodyLocation<GameSimpleSetVerifyRequest, GameSimpleSetVerifyResponse> {
    ...
    @override String get path => 'api/game/simpleGameSet';

    
    @override GameSimpleSetResponse bodyFromGetJson(dynamic json) =>  GameSimpleSetResponse.fromJson(json as Map<String, dynamic>);
                @override GameSimpleSetVerifyResponse bodyFromPostJson(dynamic json) =>  GameSimpleSetVerifyResponse.fromJson(json as Map<String, dynamic>);
}
...
class GameSimpleSetResponse {
    ...
    GameSimpleSetResponse.fromJson(Map<String, dynamic> json)
      : gameTurnId = json['gameTurnId'] as String,marketCapScaleMax = (json['marketCapScaleMax'] as num).toDouble(),marketCapScaleMin = (json['marketCapScaleMin'] as num).toDouble(),simpleGame = (json['simpleGame'] as List<dynamic>).map((dynamic val) =>  SimpleGameDto.fromJson(val as Map<String, dynamic>)).toList();

    Map<String, dynamic> toJson() => <String, dynamic>{ 'gameTurnId': gameTurnId,'marketCapScaleMax': marketCapScaleMax,'marketCapScaleMin': marketCapScaleMin,'simpleGame': simpleGame.map<dynamic>((dynamic val) => val.toJson()).toList() };
...
class GameSimpleSetVerifyRequest {
    ...
    GameSimpleSetVerifyRequest.fromJson(Map<String, dynamic> json)
      : gameTurnId = json['gameTurnId'] as String,guesses = (json['guesses'] as List<dynamic>).map((dynamic val) =>  GameSimpleSetGuessDto.fromJson(val as Map<String, dynamic>)).toList();

    Map<String, dynamic> toJson() => <String, dynamic>{ 'gameTurnId': gameTurnId,'guesses': guesses.map<dynamic>((dynamic val) => val.toJson()).toList() };
...
class GameSimpleSetVerifyResponse {
    ...
    GameSimpleSetVerifyResponse.fromJson(Map<String, dynamic> json)
      : actual = (json['actual'] as List<dynamic>).map((dynamic val) =>  GameSimpleSetGuessDto.fromJson(val as Map<String, dynamic>)).toList(),correctCount = json['correctCount'] as int,details = (json['details'] as List<dynamic>).map((dynamic val) =>  CompanyInfoDetails.fromJson(val as Map<String, dynamic>)).toList(),statsCorrectAnswers = json['statsCorrectAnswers'] as int,statsTotalTurns = json['statsTotalTurns'] as int;

    Map<String, dynamic> toJson() => <String, dynamic>{ 'actual': actual.map<dynamic>((dynamic val) => val.toJson()).toList(),'correctCount': correctCount,'details': details.map<dynamic>((dynamic val) => val.toJson()).toList(),'statsCorrectAnswers': statsCorrectAnswers,'statsTotalTurns': statsTotalTurns };
...
class GameUserBaseInfo {
    ...
    Map<String, dynamic> toJson() => <String, dynamic>{ 'avatarUrl': avatarUrl,'displayName': displayName };
...
class Holding {
    ...
    Holding.fromJson(Map<String, dynamic> json)
      : count = (json['count'] as num).toDouble(),instrument =  Instrument.fromJson(json['instrument'] as Map<String, dynamic>),purchasePriceCurrency =  CurrencyInfo.fromJson(json['purchasePriceCurrency'] as Map<String, dynamic>),purchasePriceValue = (json['purchasePriceValue'] as num).toDouble(),purchaseSpentCurrency =  CurrencyInfo.fromJson(json['purchaseSpentCurrency'] as Map<String, dynamic>),purchaseSpentValue = (json['purchaseSpentValue'] as num).toDouble();

    Map<String, dynamic> toJson() => <String, dynamic>{ 'count': count,'instrument': instrument.toJson(),'purchasePriceCurrency': purchasePriceCurrency.toJson(),'purchasePriceValue': purchasePriceValue,'purchaseSpentCurrency': purchaseSpentCurrency.toJson(),'purchaseSpentValue': purchaseSpentValue };
...
class HoldingsListResponse {
    ...
    HoldingsListResponse.fromJson(Map<String, dynamic> json)
      : data = (json['data'] as List<dynamic>).map((dynamic val) =>  Holding.fromJson(val as Map<String, dynamic>)).toList(),label =  Label.fromJson(json['label'] as Map<String, dynamic>);

    Map<String, dynamic> toJson() => <String, dynamic>{ 'data': data.map<dynamic>((dynamic val) => val.toJson()).toList(),'label': label.toJson() };
...
class ImageFileLocation implements GetLocation<dynamic> {
    ...
    @override String get path => 'api/pricedata/image/{key}'.replaceAll('{key}', this.key);

    String key;
    @override dynamic bodyFromGetJson(dynamic json) => json as dynamic;
}
...
class ImportDryRun implements PostBodyLocation<ImportStartRequest, ImportDryRunResponse> {
    ImportDryRun();
    ImportDryRun.fromJson(Map<String, dynamic> json)
      : super();

    Map<String, dynamic> toJson() => <String, dynamic>{  };

    @override String get path => 'api/portfolio/import/dryRun';

    
    @override ImportDryRunResponse bodyFromPostJson(dynamic json) =>  ImportDryRunResponse.fromJson(json as Map<String, dynamic>);
}
...
class ImportDryRunResponse {
    ...
    ImportDryRunResponse.fromJson(Map<String, dynamic> json)
      : collectedErrors = (json['collectedErrors'] as List<dynamic>).map((dynamic val) =>  ImportError.fromJson(val as Map<String, dynamic>)).toList(),errorResult = json['errorResult'] as String,exampleData = (json['exampleData'] as List<dynamic>).map((dynamic val) => (val as List<dynamic>).map((dynamic val) => val as String).toList()).toList(),exampleHeader = (json['exampleHeader'] as List<dynamic>).map((dynamic val) => val as String).toList();

    Map<String, dynamic> toJson() => <String, dynamic>{ 'collectedErrors': collectedErrors.map<dynamic>((dynamic val) => val.toJson()).toList(),'errorResult': errorResult,'exampleData': exampleData.map<dynamic>((dynamic val) => val.map<dynamic>((dynamic val) => val).toList()).toList(),'exampleHeader': exampleHeader.map<dynamic>((dynamic val) => val).toList() };
...
class ImportError {
    ...
    ImportError.fromJson(Map<String, dynamic> json)
      : error = json['error'] as String,row = (json['row'] as List<dynamic>).map((dynamic val) => val as String).toList();

    Map<String, dynamic> toJson() => <String, dynamic>{ 'error': error,'row': row.map<dynamic>((dynamic val) => val).toList() };
...
class ImportInfo implements GetLocation<UploadTransactionFileResponse> {
    ...
    Map<String, dynamic> toJson() => <String, dynamic>{ 'importId': importId };

    @override String get path => 'api/portfolio/import/info/{importId}'.replaceAll('{importId}', this.importId);

    String importId;
    @override UploadTransactionFileResponse bodyFromGetJson(dynamic json) =>  UploadTransactionFileResponse.fromJson(json as Map<String, dynamic>);
}
...
class ImportManual implements PostBodyLocation<ManualImportRequest, String> {
    ...
    Map<String, dynamic> toJson() => <String, dynamic>{ 'labelToken': labelToken };

    @override String get path => 'api/portfolio/{labelToken}/import/manual'.replaceAll('{labelToken}', this.labelToken);

    String labelToken;
    @override String bodyFromPostJson(dynamic json) => json as String;
}
...
class ImportStart implements PostBodyLocation<ImportStartRequest, ImportStartResponse> {
    ...
    @override String get path => 'api/portfolio/import/start';

    
    @override ImportStartResponse bodyFromPostJson(dynamic json) =>  ImportStartResponse.fromJson(json as Map<String, dynamic>);
}
...
class ImportStartRequest {
    ...
    ImportStartRequest.fromJson(Map<String, dynamic> json)
      : customCsvParserConfig = json['customCsvParserConfig'] == null ? null :  CustomCsvParserConfig.fromJson(json['customCsvParserConfig'] as Map<String, dynamic>),importFormat = convertImportTypeFromJson(json['importFormat'] as String),importId = json['importId'] as String;

    Map<String, dynamic> toJson() => <String, dynamic>{ 'customCsvParserConfig': customCsvParserConfig.toJson(),'importFormat': convertImportTypeToJson(importFormat),'importId': importId };
...
class ImportStartResponse {
    ...
    Map<String, dynamic> toJson() => <String, dynamic>{ 'createdLabel': createdLabel };
...
class ImportTypeDto {
    ...
    Map<String, dynamic> toJson() => <String, dynamic>{ 'label': label,'type': convertImportTypeToJson(type) };
...
class InetAddress {
    ...
    InetAddress.fromJson(Map<String, dynamic> json)
      : holder =  InetAddressHolder.fromJson(json['holder'] as Map<String, dynamic>),canonicalHostName = json['canonicalHostName'] as String;

    Map<String, dynamic> toJson() => <String, dynamic>{ 'holder': holder.toJson(),'canonicalHostName': canonicalHostName };
...
class InetAddressHolder {
    ...
    Map<String, dynamic> toJson() => <String, dynamic>{ 'originalHostName': originalHostName,'hostName': hostName,'address': address,'family': family };
...
class InitPasswordReset implements PostBodyLocation<InitPasswordResetBody, Unit> {
    ...
    @override String get path => 'api/auth/initPasswordReset';

    
    @override Unit bodyFromPostJson(dynamic json) =>  Unit.fromJson(json as Map<String, dynamic>);
}
...
class InitPasswordResetBody {
    ...
    Map<String, dynamic> toJson() => <String, dynamic>{ 'emailAddress': emailAddress };
...
class Instrument {
    ...
    Instrument.fromJson(Map<String, dynamic> json)
      : exchange =  Exchange.fromJson(json['exchange'] as Map<String, dynamic>),figi = json['figi'] as String,id = json['id'] as String,isin = json['isin'] as String,name = json['name'] as String,symbol = json['symbol'] as String,symbolEod = json['symbolEod'] as String,type = convertInstrumentTypeFromJson(json['type'] as String);

    Map<String, dynamic> toJson() => <String, dynamic>{ 'exchange': exchange.toJson(),'figi': figi,'id': id,'isin': isin,'name': name,'symbol': symbol,'symbolEod': symbolEod,'type': convertInstrumentTypeToJson(type) };
...
class InstrumentBase {
    ...
    Map<String, dynamic> toJson() => <String, dynamic>{ 'symbol': symbol,'symbolSuffix': symbolSuffix,'symbolWithoutSuffix': symbolWithoutSuffix };
...
class InstrumentImageDto {
    ...
    Map<String, dynamic> toJson() => <String, dynamic>{ 'fileName': fileName,'height': height,'id': id,'imageType': convertImageTypeToJson(imageType),'mimeType': mimeType,'width': width };
...
class InstrumentLogoLocation implements GetLocation<dynamic> {
    ...
    @override String get path => 'api/pricedata/instrument/{key}/logo'.replaceAll('{key}', this.key);
...
class Label {
    ...
    Label.fromJson(Map<String, dynamic> json)
      : archivedAt =  InstantWrapper.fromJson(json['archivedAt'] as Map<String, dynamic>),id = json['id'] as String,name = json['name'] as String,permissions = (json['permissions'] as List<dynamic>).map((dynamic val) =>  Permission.fromJson(val as Map<String, dynamic>)).toList(),privacy = convertLabelPrivacyFromJson(json['privacy'] as String),token = json['token'] as String,type = convertLabelTypeFromJson(json['type'] as String);

    Map<String, dynamic> toJson() => <String, dynamic>{ 'archivedAt': archivedAt.toJson(),'id': id,'name': name,'permissions': permissions.map<dynamic>((dynamic val) => val.toJson()).toList(),'privacy': convertLabelPrivacyToJson(privacy),'token': token,'type': convertLabelTypeToJson(type) };
...
class LeaderboardEntry {
    ...
    Map<String, dynamic> toJson() => <String, dynamic>{ 'avatarUrl': avatarUrl,'displayName': displayName,'loggedInUser': loggedInUser,'rank': rank,'statsCorrectAnswers': statsCorrectAnswers,'statsTotalTurns': statsTotalTurns,'userToken': userToken };
...
class LeaderboardSimpleLocation implements GetLocation<LeaderboardSimpleResponse> {
    ...
    @override String get path => 'api/game/leaderboard/simple';

    
    @override LeaderboardSimpleResponse bodyFromGetJson(dynamic json) =>  LeaderboardSimpleResponse.fromJson(json as Map<String, dynamic>);
}
...
class LeaderboardSimpleResponse {
    ...
    LeaderboardSimpleResponse.fromJson(Map<String, dynamic> json)
      : leaderboardEntries = (json['leaderboardEntries'] as List<dynamic>).map((dynamic val) =>  LeaderboardEntry.fromJson(val as Map<String, dynamic>)).toList();

    Map<String, dynamic> toJson() => <String, dynamic>{ 'leaderboardEntries': leaderboardEntries.map<dynamic>((dynamic val) => val.toJson()).toList() };
...
class LogEvent implements PostBodyLocation<LogEventRequest, Unit> {
    ...
    @override String get path => 'api/auth/log';
...
class LogEventRequest {
    ...
    LogEventRequest.fromJson(Map<String, dynamic> json)
      : email = json['email'] as String,info = (json['info'] as Map<dynamic, dynamic>).map<String, dynamic>((dynamic key, dynamic value) => MapEntry<String, dynamic>(key as String, value as dynamic)),label = json['label'] as String;

    Map<String, dynamic> toJson() => <String, dynamic>{ 'email': email,'info': info.map<String, dynamic>((dynamic key, dynamic value) => MapEntry<String, dynamic>((key) as String, (value))),'label': label };
...
class LogShortLinkLocation implements PostBodyLocation<LogShortLinkRequest, Unit> {
    ...
    @override String get path => 'api/game/challenge/invite/shortlink';
...
class LogShortLinkRequest {
    ...
    Map<String, dynamic> toJson() => <String, dynamic>{ 'inviteToken': inviteToken,'shortLink': shortLink };
...
class Login implements PostBodyLocation<LoginRequest, ContextDto> {
    ...
    @override String get path => 'api/auth/login';
...
class LoginRequest {
    ...
    Map<String, dynamic> toJson() => <String, dynamic>{ 'email': email,'password': password };
...
class Logout implements PostBodyLocation<EmptyRequestDto, ContextDto> {
    ...
    @override String get path => 'api/auth/logout';
...
class ManualImportRequest {
    ...
    ManualImportRequest.fromJson(Map<String, dynamic> json)
      : transactions = (json['transactions'] as List<dynamic>).map((dynamic val) =>  ManualImportTransaction.fromJson(val as Map<String, dynamic>)).toList();

    Map<String, dynamic> toJson() => <String, dynamic>{ 'transactions': transactions.map<dynamic>((dynamic val) => val.toJson()).toList() };
...
class ManualImportTransaction {
    ...
    ManualImportTransaction.fromJson(Map<String, dynamic> json)
      : count = (json['count'] as num).toDouble(),date =  InstantWrapper.fromJson(json['date'] as Map<String, dynamic>),pricePerShare = (json['pricePerShare'] as num).toDouble(),symbol = json['symbol'] as String,totalSpent = (json['totalSpent'] as num).toDouble(),type = convertTransactionTypeFromJson(json['type'] as String);

    Map<String, dynamic> toJson() => <String, dynamic>{ 'count': count,'date': date.toJson(),'pricePerShare': pricePerShare,'symbol': symbol,'totalSpent': totalSpent,'type': convertTransactionTypeToJson(type) };
...
class ParserConfig {
    ParserConfig();
    ParserConfig.fromJson(Map<String, dynamic> json)
      : super();
...
class PdCompanyInfo {
    PdCompanyInfo(this.description, this.id, this.industries, this.instrument, this.instrumentId, this.label, this.logo, this.updatedAt, this.website, this.wikidataEntityUri, this.wikipediaArticleUri);
    PdCompanyInfo.fromJson(Map<String, dynamic> json)
      : description = json['description'] as String,id = json['id'] as String,industries = (json['industries'] as List<dynamic>).map((dynamic val) =>  PdCompanyInfoIndustry.fromJson(val as Map<String, dynamic>)).toList(),instrument =  PdInstrumentEntity.fromJson(json['instrument'] as Map<String, dynamic>),instrumentId = json['instrumentId'] as String,label = json['label'] as String,logo =  URL.fromJson(json['logo'] as Map<String, dynamic>),updatedAt =  InstantWrapper.fromJson(json['updatedAt'] as Map<String, dynamic>),website =  URL.fromJson(json['website'] as Map<String, dynamic>),wikidataEntityUri = json['wikidataEntityUri'] as String,wikipediaArticleUri = json['wikipediaArticleUri'] as String;

    Map<String, dynamic> toJson() => <String, dynamic>{ 'description': description,'id': id,'industries': industries.map<dynamic>((dynamic val) => val.toJson()).toList(),'instrument': instrument.toJson(),'instrumentId': instrumentId,'label': label,'logo': logo.toJson(),'updatedAt': updatedAt.toJson(),'website': website.toJson(),'wikidataEntityUri': wikidataEntityUri,'wikipediaArticleUri': wikipediaArticleUri };
...
class PdCompanyInfoIndustry {
    ...
    Map<String, dynamic> toJson() => <String, dynamic>{ 'id': id,'label': label,'wikiDataUri': wikiDataUri };
...
class PdImageFile {
    ...
    PdImageFile.fromJson(Map<String, dynamic> json)
      : brightnessRatio = (json['brightnessRatio'] as num).toDouble(),createdAt =  InstantWrapper.fromJson(json['createdAt'] as Map<String, dynamic>),fileName = json['fileName'] as String,id = json['id'] as String,imageData = (json['imageData'] as List<dynamic>).map((dynamic val) => val as int).toList(),imageHeight = json['imageHeight'] as int,imageType = convertImageTypeFromJson(json['imageType'] as String),imageWidth = json['imageWidth'] as int,mimeType = json['mimeType'] as String,mimeTypes = (json['mimeTypes'] as List<dynamic>).map((dynamic val) => val as String).toList(),url = json['url'] as String;

    Map<String, dynamic> toJson() => <String, dynamic>{ 'brightnessRatio': brightnessRatio,'createdAt': createdAt.toJson(),'fileName': fileName,'id': id,'imageData': imageData.map<dynamic>((dynamic val) => val).toList(),'imageHeight': imageHeight,'imageType': convertImageTypeToJson(imageType),'imageWidth': imageWidth,'mimeType': mimeType,'mimeTypes': mimeTypes.map<dynamic>((dynamic val) => val).toList(),'url': url };
...
class PdInstrument implements InstrumentBase {
    PdInstrument(this.symbol, this.symbolSuffix, this.symbolWithoutSuffix, this.createdAt, this.currency, this.exchange, this.exchangeName, this.id, this.micCompositionCode, this.name, this.shortName, this.snapshot, this.type);
    PdInstrument.fromJson(Map<String, dynamic> json)
      : symbol = json['symbol'] as String,symbolSuffix = json['symbolSuffix'] as String,symbolWithoutSuffix = json['symbolWithoutSuffix'] as String,createdAt =  InstantWrapper.fromJson(json['createdAt'] as Map<String, dynamic>),currency = json['currency'] as String,exchange = json['exchange'] as String,exchangeName = json['exchangeName'] as String,id = json['id'] as String,micCompositionCode = json['micCompositionCode'] as String,name = json['name'] as String,shortName = json['shortName'] as String,snapshot =  PdInstrumentSnapshot.fromJson(json['snapshot'] as Map<String, dynamic>),type = convertPdInstrumentTypeFromJson(json['type'] as String);

    Map<String, dynamic> toJson() => <String, dynamic>{ 'symbol': symbol,'symbolSuffix': symbolSuffix,'symbolWithoutSuffix': symbolWithoutSuffix,'createdAt': createdAt.toJson(),'currency': currency,'exchange': exchange,'exchangeName': exchangeName,'id': id,'micCompositionCode': micCompositionCode,'name': name,'shortName': shortName,'snapshot': snapshot.toJson(),'type': convertPdInstrumentTypeToJson(type) };
...
class PdInstrumentConfig {
    ...
    PdInstrumentConfig.fromJson(Map<String, dynamic> json)
      : id = json['id'] as String,instrument =  PdInstrumentEntity.fromJson(json['instrument'] as Map<String, dynamic>),preferredLogo = json['preferredLogo'] == null ? null :  PdImageFile.fromJson(json['preferredLogo'] as Map<String, dynamic>),wikidataEntity = json['wikidataEntity'] as String;

    Map<String, dynamic> toJson() => <String, dynamic>{ 'id': id,'instrument': instrument.toJson(),'preferredLogo': preferredLogo.toJson(),'wikidataEntity': wikidataEntity };
...
class PdInstrumentDto {
    ...
    Map<String, dynamic> toJson() => <String, dynamic>{ 'currencyCode': currencyCode,'id': id,'marketCap': marketCap,'name': name,'symbol': symbol,'type': convertPdInstrumentTypeToJson(type),'volume': volume,'website': website };
...
class PdInstrumentEntity implements InstrumentBase {
    ...
    PdInstrumentEntity.fromJson(Map<String, dynamic> json)
      : symbol = json['symbol'] as String,symbolSuffix = json['symbolSuffix'] as String,symbolWithoutSuffix = json['symbolWithoutSuffix'] as String,companyImagesLastFetched =  InstantWrapper.fromJson(json['companyImagesLastFetched'] as Map<String, dynamic>),companyInfoLastFetched =  InstantWrapper.fromJson(json['companyInfoLastFetched'] as Map<String, dynamic>),companyName = json['companyName'] as String,companyWebsite = json['companyWebsite'] as String,companyWebsiteUrl = json['companyWebsiteUrl'] == null ? null :  URL.fromJson(json['companyWebsiteUrl'] as Map<String, dynamic>),config = json['config'] == null ? null :  PdInstrumentConfig.fromJson(json['config'] as Map<String, dynamic>),filledEodEnd = json['filledEodEnd'] as /* yyyy-mm-dd date LocalDate */String,filledEodStart = json['filledEodStart'] as /* yyyy-mm-dd date LocalDate */String,id = json['id'] as String,images = (json['images'] as List<dynamic>).map((dynamic val) =>  PdInstrumentImage.fromJson(val as Map<String, dynamic>)).toList(),lastStockSnapshot = json['lastStockSnapshot'] == null ? null :  PdStockDataSnapshotEntity.fromJson(json['lastStockSnapshot'] as Map<String, dynamic>),type = convertPdInstrumentTypeFromJson(json['type'] as String);

    Map<String, dynamic> toJson() => <String, dynamic>{ 'symbol': symbol,'symbolSuffix': symbolSuffix,'symbolWithoutSuffix': symbolWithoutSuffix,'companyImagesLastFetched': companyImagesLastFetched.toJson(),'companyInfoLastFetched': companyInfoLastFetched.toJson(),'companyName': companyName,'companyWebsite': companyWebsite,'companyWebsiteUrl': companyWebsiteUrl.toJson(),'config': config.toJson(),'filledEodEnd': filledEodEnd,'filledEodStart': filledEodStart,'id': id,'images': images.map<dynamic>((dynamic val) => val.toJson()).toList(),'lastStockSnapshot': lastStockSnapshot.toJson(),'type': convertPdInstrumentTypeToJson(type) };
...
class PdInstrumentImage {
    ...
    PdInstrumentImage.fromJson(Map<String, dynamic> json)
      : id =  PdInstrumentImageId.fromJson(json['id'] as Map<String, dynamic>),imageFile =  PdImageFile.fromJson(json['imageFile'] as Map<String, dynamic>),instrument =  PdInstrumentEntity.fromJson(json['instrument'] as Map<String, dynamic>);

    Map<String, dynamic> toJson() => <String, dynamic>{ 'id': id.toJson(),'imageFile': imageFile.toJson(),'instrument': instrument.toJson() };
...
class PdInstrumentImageId {
    ...
    Map<String, dynamic> toJson() => <String, dynamic>{ 'imageFileId': imageFileId,'instrumentId': instrumentId };
...
class PdInstrumentSnapshot {
    ...
    PdInstrumentSnapshot.fromJson(Map<String, dynamic> json)
      : regularMarketPrice = (json['regularMarketPrice'] as num).toDouble(),stockStats = json['stockStats'] == null ? null :  PdStockStats.fromJson(json['stockStats'] as Map<String, dynamic>),volume = (json['volume'] as num).toDouble();

    Map<String, dynamic> toJson() => <String, dynamic>{ 'regularMarketPrice': regularMarketPrice,'stockStats': stockStats.toJson(),'volume': volume };
...
class PdStockDataSnapshotEntity {
    ...
    PdStockDataSnapshotEntity.fromJson(Map<String, dynamic> json)
      : currency =  Currency.fromJson(json['currency'] as Map<String, dynamic>),date =  InstantWrapper.fromJson(json['date'] as Map<String, dynamic>),epsForward = (json['epsForward'] as num).toDouble(),epsTrailing = (json['epsTrailing'] as num).toDouble(),exchangeName = json['exchangeName'] as String,floatShares = (json['floatShares'] as num).toDouble(),id = json['id'] as String,instrument =  PdInstrumentEntity.fromJson(json['instrument'] as Map<String, dynamic>),lastSplitDate =  InstantWrapper.fromJson(json['lastSplitDate'] as Map<String, dynamic>),lastSplitFactor = json['lastSplitFactor'] as String,marketCap = (json['marketCap'] as num).toDouble(),micCompositionCode = json['micCompositionCode'] as String,peForward = (json['peForward'] as num).toDouble(),peTrailing = (json['peTrailing'] as num).toDouble(),profitMargins = (json['profitMargins'] as num).toDouble(),regularMarketPrice = (json['regularMarketPrice'] as num).toDouble(),sharesOutstanding = (json['sharesOutstanding'] as num).toDouble(),sharesShort = (json['sharesShort'] as num).toDouble(),volume = (json['volume'] as num).toDouble();

    Map<String, dynamic> toJson() => <String, dynamic>{ 'currency': currency.toJson(),'date': date.toJson(),'epsForward': epsForward,'epsTrailing': epsTrailing,'exchangeName': exchangeName,'floatShares': floatShares,'id': id,'instrument': instrument.toJson(),'lastSplitDate': lastSplitDate.toJson(),'lastSplitFactor': lastSplitFactor,'marketCap': marketCap,'micCompositionCode': micCompositionCode,'peForward': peForward,'peTrailing': peTrailing,'profitMargins': profitMargins,'regularMarketPrice': regularMarketPrice,'sharesOutstanding': sharesOutstanding,'sharesShort': sharesShort,'volume': volume };
...
class PdStockStats {
    ...
    Map<String, dynamic> toJson() => <String, dynamic>{ 'floatShares': floatShares,'marketCap': marketCap,'sharesOutstanding': sharesOutstanding };
...
class Permission {
    ...
    Permission.fromJson(Map<String, dynamic> json)
      : id = json['id'] as String,label =  Label.fromJson(json['label'] as Map<String, dynamic>),type = convertPermissionTypeFromJson(json['type'] as String),user =  UserInfo.fromJson(json['user'] as Map<String, dynamic>);

    Map<String, dynamic> toJson() => <String, dynamic>{ 'id': id,'label': label.toJson(),'type': convertPermissionTypeToJson(type),'user': user.toJson() };
...
class PortfolioLabel implements GetLocation<PortfolioTransactionListResponse>, PutBodyLocation<PortfolioLabelUpdateRequest, String> {
    ...
    @override String get path => 'api/portfolio/{labelToken}'.replaceAll('{labelToken}', this.labelToken);

    String labelToken;
    @override PortfolioTransactionListResponse bodyFromGetJson(dynamic json) =>  PortfolioTransactionListResponse.fromJson(json as Map<String, dynamic>);
                @override String bodyFromPutJson(dynamic json) => json as String;
}
...
class PortfolioLabelHoldings implements GetLocation<HoldingsListResponse> {
    ...
    @override String get path => 'api/portfolio/{labelToken}/holdings'.replaceAll('{labelToken}', this.labelToken);

    String labelToken;
    @override HoldingsListResponse bodyFromGetJson(dynamic json) =>  HoldingsListResponse.fromJson(json as Map<String, dynamic>);
}
...
class PortfolioLabelUpdateRequest {
    ...
    Map<String, dynamic> toJson() => <String, dynamic>{ 'archived': archived,'labelName': labelName,'privacy': convertLabelPrivacyToJson(privacy) };
...
class PortfolioList implements GetLocation<PortfolioListResponse>, PostBodyLocation<PortfolioCreateRequest, String> {
    ...
    @override String get path => 'api/portfolio';

    
    @override PortfolioListResponse bodyFromGetJson(dynamic json) =>  PortfolioListResponse.fromJson(json as Map<String, dynamic>);
                @override String bodyFromPostJson(dynamic json) => json as String;
}
...
class PortfolioListResponse {
    ...
    PortfolioListResponse.fromJson(Map<String, dynamic> json)
      : data = (json['data'] as List<dynamic>).map((dynamic val) =>  Label.fromJson(val as Map<String, dynamic>)).toList();

    Map<String, dynamic> toJson() => <String, dynamic>{ 'data': data.map<dynamic>((dynamic val) => val.toJson()).toList() };
...
class PortfolioTransactionListResponse {
    ...
    PortfolioTransactionListResponse.fromJson(Map<String, dynamic> json)
      : data = (json['data'] as List<dynamic>).map((dynamic val) =>  Transaction.fromJson(val as Map<String, dynamic>)).toList(),label =  Label.fromJson(json['label'] as Map<String, dynamic>);
...
class RegisterDeviceLocation implements PostBodyLocation<RegisterDeviceRequest, RegisterDeviceResponse> {
    ...
    @override String get path => 'api/game/registerDevice';

    
    @override RegisterDeviceResponse bodyFromPostJson(dynamic json) =>  RegisterDeviceResponse.fromJson(json as Map<String, dynamic>);
}
...
class RegisterDeviceRequest {
    ...
    Map<String, dynamic> toJson() => <String, dynamic>{ 'deviceInfo': deviceInfo,'osInfo': osInfo,'platform': convertDevicePlatformToJson(platform) };
...
class RegisterDeviceResponse {
    ...
    Map<String, dynamic> toJson() => <String, dynamic>{ 'deviceKey': deviceKey,'userKey': userKey };
...
class SignUp implements PostBodyLocation<SignUpRequest, Unit> {
    ...
    @override String get path => 'api/auth/signup';
...
class SimpleGameDto {
    ...
    SimpleGameDto.fromJson(Map<String, dynamic> json)
      : instrumentKey = json['instrumentKey'] as String,logo =  InstrumentImageDto.fromJson(json['logo'] as Map<String, dynamic>),symbol = json['symbol'] as String;

    Map<String, dynamic> toJson() => <String, dynamic>{ 'instrumentKey': instrumentKey,'logo': logo.toJson(),'symbol': symbol };
...
class StatsSummary implements GetLocation<StatsSummaryResponse> {
    ...
    Map<String, dynamic> toJson() => <String, dynamic>{ 'endDate': endDate,'startDate': startDate,'type': convertStatsTypeToJson(type) };

    @override String get path => Uri.parse('api/pricedata/stats').replace(queryParameters: <String, dynamic>{'endDate': endDate?.toString(),'startDate': startDate?.toString(),'type': type,}).toString();

    /* yyyy-mm-dd date LocalDate */String endDate;
                /* yyyy-mm-dd date LocalDate */String startDate;
                StatsType type;
    @override StatsSummaryResponse bodyFromGetJson(dynamic json) =>  StatsSummaryResponse.fromJson(json as Map<String, dynamic>);
}
...
class StatsSummaryResponse {
    ...
    StatsSummaryResponse.fromJson(Map<String, dynamic> json)
      : yearMoveShares = (json['yearMoveShares'] as List<dynamic>).map((dynamic val) =>  YearMoverShares.fromJson(val as Map<String, dynamic>)).toList();

    Map<String, dynamic> toJson() => <String, dynamic>{ 'yearMoveShares': yearMoveShares.map<dynamic>((dynamic val) => val.toJson()).toList() };
...
class StatusLocation implements GetLocation<StatusResponseDto> {
    ...
    @override String get path => 'api/status';

    
    @override StatusResponseDto bodyFromGetJson(dynamic json) =>  StatusResponseDto.fromJson(json as Map<String, dynamic>);
}
...
class StatusResponseDto {
    ...
    StatusResponseDto.fromJson(Map<String, dynamic> json)
      : appMetrics =  AppMetricsDto.fromJson(json['appMetrics'] as Map<String, dynamic>),build = json['build'] as String,jvmMetrics = (json['jvmMetrics'] as Map<dynamic, dynamic>).map<String, dynamic>((dynamic key, dynamic value) => MapEntry<String, dynamic>(key as String, value as dynamic));

    Map<String, dynamic> toJson() => <String, dynamic>{ 'appMetrics': appMetrics.toJson(),'build': build,'jvmMetrics': jvmMetrics.map<String, dynamic>((dynamic key, dynamic value) => MapEntry<String, dynamic>((key) as String, (value))) };
...
class SymbolInfo implements GetLocation<SymbolInfoResponse> {
    ...
    Map<String, dynamic> toJson() => <String, dynamic>{ 'symbols': symbols.map<dynamic>((dynamic val) => val).toList() };

    @override String get path => Uri.parse('api/pricedata/symbolInfos').replace(queryParameters: <String, dynamic>{'symbols': symbols,}).toString();

    List<String> symbols;
    @override SymbolInfoResponse bodyFromGetJson(dynamic json) =>  SymbolInfoResponse.fromJson(json as Map<String, dynamic>);
}
...
class SymbolInfoResponse {
    ...
    SymbolInfoResponse.fromJson(Map<String, dynamic> json)
      : companyInfos = (json['companyInfos'] as Map<dynamic, dynamic>).map<String, PdCompanyInfo>((dynamic key, dynamic value) => MapEntry<String, PdCompanyInfo>(key as String,  PdCompanyInfo.fromJson(value as Map<String, dynamic>)));

    Map<String, dynamic> toJson() => <String, dynamic>{ 'companyInfos': companyInfos.map<String, dynamic>((dynamic key, dynamic value) => MapEntry<String, dynamic>((key) as String, (value.toJson()))) };
...
class SymbolSearch implements GetLocation<SymbolSearchResponse> {
    ...
    @override String get path => Uri.parse('api/pricedata/search').replace(queryParameters: <String, dynamic>{'query': query?.toString(),}).toString();

    String query;
    @override SymbolSearchResponse bodyFromGetJson(dynamic json) =>  SymbolSearchResponse.fromJson(json as Map<String, dynamic>);
}
...
class SymbolSearchResponse {
    ...
    SymbolSearchResponse.fromJson(Map<String, dynamic> json)
      : snapshot = (json['snapshot'] as List<dynamic>).map((dynamic val) =>  PdInstrument.fromJson(val as Map<String, dynamic>)).toList();

    Map<String, dynamic> toJson() => <String, dynamic>{ 'snapshot': snapshot.map<dynamic>((dynamic val) => val.toJson()).toList() };
...
class TestMethodGetResponse {
    ...
    Map<String, dynamic> toJson() => <String, dynamic>{ 'tmp': tmp };
...
class TestMethodLocation implements GetLocation<TestMethodGetResponse>, PostBodyLocation<TestMethodPostRequest, TestMethodPostResponse>, PutBodyLocation<TestMethodPutRequest, TestMethodPutResponse> {
    ...
    Map<String, dynamic> toJson() => <String, dynamic>{ 'param': param };

    @override String get path => 'api/test/method/{param}'.replaceAll('{param}', this.param);
...
class Transaction {
    ...
    Transaction.fromJson(Map<String, dynamic> json)
      : count = (json['count'] as num).toDouble(),createdAt =  InstantWrapper.fromJson(json['createdAt'] as Map<String, dynamic>),id = json['id'] as String,instrument =  Instrument.fromJson(json['instrument'] as Map<String, dynamic>),label =  Label.fromJson(json['label'] as Map<String, dynamic>),transactionAt =  InstantWrapper.fromJson(json['transactionAt'] as Map<String, dynamic>),type = convertTransactionTypeFromJson(json['type'] as String),values = (json['values'] as List<dynamic>).map((dynamic val) =>  TransactionValue.fromJson(val as Map<String, dynamic>)).toList();

    Map<String, dynamic> toJson() => <String, dynamic>{ 'count': count,'createdAt': createdAt.toJson(),'id': id,'instrument': instrument.toJson(),'label': label.toJson(),'transactionAt': transactionAt.toJson(),'type': convertTransactionTypeToJson(type),'values': values.map<dynamic>((dynamic val) => val.toJson()).toList() };
...
class TransactionValue {
    ...
    TransactionValue.fromJson(Map<String, dynamic> json)
      : amount = (json['amount'] as num).toDouble(),currency =  CurrencyInfo.fromJson(json['currency'] as Map<String, dynamic>),id = json['id'] as String,transaction =  Transaction.fromJson(json['transaction'] as Map<String, dynamic>),type = convertTransactionValueTypeFromJson(json['type'] as String);

    Map<String, dynamic> toJson() => <String, dynamic>{ 'amount': amount,'currency': currency.toJson(),'id': id,'transaction': transaction.toJson(),'type': convertTransactionValueTypeToJson(type) };
...
class URL {
    URL(this.protocol, this.host, this.port, this.file, this.query, this.authority, this.path, this.userInfo, this.ref, this.hostAddress, this.handler, this.tempState);
    URL.fromJson(Map<String, dynamic> json)
      : protocol = json['protocol'] as String,host = json['host'] as String,port = json['port'] as int,file = json['file'] as String,query = json['query'] as String,authority = json['authority'] as String,path = json['path'] as String,userInfo = json['userInfo'] as String,ref = json['ref'] as String,hostAddress =  InetAddress.fromJson(json['hostAddress'] as Map<String, dynamic>),handler =  URLStreamHandler.fromJson(json['handler'] as Map<String, dynamic>),tempState =  UrlDeserializedState.fromJson(json['tempState'] as Map<String, dynamic>);

    Map<String, dynamic> toJson() => <String, dynamic>{ 'protocol': protocol,'host': host,'port': port,'file': file,'query': query,'authority': authority,'path': path,'userInfo': userInfo,'ref': ref,'hostAddress': hostAddress.toJson(),'handler': handler.toJson(),'tempState': tempState.toJson() };
...
class UpdateProfile implements PostBodyLocation<UpdateProfileBody, ContextDto> {
    ...
    @override String get path => 'api/auth/profile/update';
...
class UpdateProfileBody {
    ...
    Map<String, dynamic> toJson() => <String, dynamic>{ 'passwordChange': passwordChange };
...
class UploadTransactionFileResponse {
    UploadTransactionFileResponse(this.availableImportFormats, this.customCsvParserConfig, this.importFormat, this.importId);
    UploadTransactionFileResponse.fromJson(Map<String, dynamic> json)
      : availableImportFormats = (json['availableImportFormats'] as List<dynamic>).map((dynamic val) =>  ImportTypeDto.fromJson(val as Map<String, dynamic>)).toList(),customCsvParserConfig = json['customCsvParserConfig'] == null ? null :  CustomCsvParserConfig.fromJson(json['customCsvParserConfig'] as Map<String, dynamic>),importFormat = convertImportTypeFromJson(json['importFormat'] as String),importId = json['importId'] as String;

    Map<String, dynamic> toJson() => <String, dynamic>{ 'availableImportFormats': availableImportFormats.map<dynamic>((dynamic val) => val.toJson()).toList(),'customCsvParserConfig': customCsvParserConfig.toJson(),'importFormat': convertImportTypeToJson(importFormat),'importId': importId };
...
class UrlDeserializedState {
    ...
    UrlDeserializedState.fromJson(Map<String, dynamic> json)
      : protocol = json['protocol'] as String,host = json['host'] as String,port = json['port'] as int,authority = json['authority'] as String,file = json['file'] as String,ref = json['ref'] as String;

    Map<String, dynamic> toJson() => <String, dynamic>{ 'protocol': protocol,'host': host,'port': port,'authority': authority,'file': file,'ref': ref };
...
class UserAuthEmailToken {
    ...
    UserAuthEmailToken.fromJson(Map<String, dynamic> json)
      : createdAt =  InstantWrapper.fromJson(json['createdAt'] as Map<String, dynamic>),email = json['email'] as String,sentEmailAt =  InstantWrapper.fromJson(json['sentEmailAt'] as Map<String, dynamic>),token = json['token'] as String,usedAt =  InstantWrapper.fromJson(json['usedAt'] as Map<String, dynamic>),user =  UserInfo.fromJson(json['user'] as Map<String, dynamic>);

    Map<String, dynamic> toJson() => <String, dynamic>{ 'createdAt': createdAt.toJson(),'email': email,'sentEmailAt': sentEmailAt.toJson(),'token': token,'usedAt': usedAt.toJson(),'user': user.toJson() };
...
class UserInfo {
    ...
    UserInfo.fromJson(Map<String, dynamic> json)
      : authTokens = (json['authTokens'] as List<dynamic>).map((dynamic val) =>  UserAuthEmailToken.fromJson(val as Map<String, dynamic>)).toList(),createdAt =  InstantWrapper.fromJson(json['createdAt'] as Map<String, dynamic>),displayName = json['displayName'] as String,email = json['email'] as String,firstName = json['firstName'] as String,id = json['id'] as String,lastName = json['lastName'] as String,passwordHash = json['passwordHash'] as String,phoneNumber = json['phoneNumber'] as String,userType = convertUserTypeFromJson(json['userType'] as String);

    Map<String, dynamic> toJson() => <String, dynamic>{ 'authTokens': authTokens.map<dynamic>((dynamic val) => val.toJson()).toList(),'createdAt': createdAt.toJson(),'displayName': displayName,'email': email,'firstName': firstName,'id': id,'lastName': lastName,'passwordHash': passwordHash,'phoneNumber': phoneNumber,'userType': convertUserTypeToJson(userType) };
...
class UserInfoAvatarUpload implements PostBodyLocation<Unit, UserInfoResponse> {
    ...
    @override String get path => 'api/game/userInfo/upload';

    
    @override UserInfoResponse bodyFromPostJson(dynamic json) =>  UserInfoResponse.fromJson(json as Map<String, dynamic>);
}
...
class UserInfoLocation implements PostBodyLocation<UserInfoRequest, UserInfoResponse> {
    ...
    @override String get path => 'api/game/userInfo';
...
class UserInfoRequest {
    ...
    Map<String, dynamic> toJson() => <String, dynamic>{ 'appVersion': appVersion,'deviceInfo': deviceInfo,'fcmToken': fcmToken };
...
class UserInfoResponse {
    ...
    UserInfoResponse.fromJson(Map<String, dynamic> json)
      : avatarUrl = json['avatarUrl'] as String,createdAt =  InstantWrapper.fromJson(json['createdAt'] as Map<String, dynamic>),displayName = json['displayName'] as String,email = json['email'] as String,key = json['key'] as String,statsCorrectAnswers = json['statsCorrectAnswers'] as int,statsTotalTurns = json['statsTotalTurns'] as int,userType = convertGameUserTypeFromJson(json['userType'] as String);

    Map<String, dynamic> toJson() => <String, dynamic>{ 'avatarUrl': avatarUrl,'createdAt': createdAt.toJson(),'displayName': displayName,'email': email,'key': key,'statsCorrectAnswers': statsCorrectAnswers,'statsTotalTurns': statsTotalTurns,'userType': convertGameUserTypeToJson(userType) };
...
class UserInfoUpdateLocation implements PostBodyLocation<UserInfoUpdateRequest, UserInfoResponse> {
    ...
    @override String get path => 'api/game/userInfo/update';
...
class UserInfoUpdateRequest {
    ...
    Map<String, dynamic> toJson() => <String, dynamic>{ 'displayName': displayName,'email': email };
...
class VerifyToken implements PostBodyLocation<VerifyTokenRequest, ContextDto> {
    ...
    @override String get path => 'api/auth/verifyToken';
...
class VerifyTokenRequest {
    ...
    Map<String, dynamic> toJson() => <String, dynamic>{ 'emailToken': emailToken };
...
class WDCompanyInfoDto {
    ...
    WDCompanyInfoDto.fromJson(Map<String, dynamic> json)
      : companyDescription = json['companyDescription'] as String,companyLabel = json['companyLabel'] as String,industry = json['industry'] == null ? null :  URI.fromJson(json['industry'] as Map<String, dynamic>),industryLabel = json['industryLabel'] as String,logo =  URL.fromJson(json['logo'] as Map<String, dynamic>),tickerSymbol = json['tickerSymbol'] as String,website =  URL.fromJson(json['website'] as Map<String, dynamic>),wikidataEntityUri = json['wikidataEntityUri'] as String,wikipediaArticleUri = json['wikipediaArticleUri'] as String;

    Map<String, dynamic> toJson() => <String, dynamic>{ 'companyDescription': companyDescription,'companyLabel': companyLabel,'industry': industry.toJson(),'industryLabel': industryLabel,'logo': logo.toJson(),'tickerSymbol': tickerSymbol,'website': website.toJson(),'wikidataEntityUri': wikidataEntityUri,'wikipediaArticleUri': wikipediaArticleUri };
...
class YearMoverShares {
    ...
    Map<String, dynamic> toJson() => <String, dynamic>{ 'companyLabel': companyLabel,'companyWebsite': companyWebsite,'instrumentId': instrumentId,'instrumentSymbol': instrumentSymbol,'marketCap': marketCap,'volume': volume,'weekMoveDay': weekMoveDay,'weekMoveValue': weekMoveValue,'yearMoveDay': yearMoveDay,'yearMoveValue': yearMoveValue };
