// DTOs autogenerated at 2018-12-13 02:36:13
...
class GameSimpleSetGuessDto {
    ...
    GameSimpleSetGuessDto.fromJson(Map<String, dynamic> json)
      : instrumentKey = json['instrumentKey'] as String,marketCap = json['marketCap'] as double;
...
class GameSimpleSetResponse {
    ...
    GameSimpleSetResponse.fromJson(Map<String, dynamic> json)
      : gameTurnId = json['gameTurnId'] as String,marketCapScaleMax = json['marketCapScaleMax'] as double,marketCapScaleMin = json['marketCapScaleMin'] as double,simpleGame = (json['simpleGame'] as List<dynamic>).map((val) => SimpleGameDto.fromJson(val));
...
class RegisterDeviceResponse {
    ...
    RegisterDeviceResponse(this.deviceKey);
    ...
    Map<String, dynamic> toJson() => { 'deviceKey': deviceKey };
}
