// DTOs autogenerated at 2019-08-10 08:11:50
...
class URL {
    ...
    URL.fromJson(Map<String, dynamic> json)
      : protocol = json['protocol'] as String,host = json['host'] as String,port = json['port'] as int,file = json['file'] as String,query = json['query'] as String,authority = json['authority'] as String,path = json['path'] as String,userInfo = json['userInfo'] as String,ref = json['ref'] as String,hostAddress =  InetAddress.fromJson(json['hostAddress'] as Map<String, dynamic>),handler =  URLStreamHandler.fromJson(json['handler'] as Map<String, dynamic>),hashCode = json['hashCode'] as int,tempState =  UrlDeserializedState.fromJson(json['tempState'] as Map<String, dynamic>);

    Map<String, dynamic> toJson() => <String, dynamic>{ 'protocol': protocol,'host': host,'port': port,'file': file,'query': query,'authority': authority,'path': path,'userInfo': userInfo,'ref': ref,'hostAddress': hostAddress.toJson(),'handler': handler.toJson(),'hashCode': hashCode,'tempState': tempState.toJson() };
...
class UrlDeserializedState {
    ...
    Map<String, dynamic> toJson() => <String, dynamic>{ 'protocol': protocol,'host': host,'port': port,'authority': authority,'file': file,'ref': ref,'hashCode': hashCode };
